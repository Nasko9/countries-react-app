    ...
    <div className="bg-primary text-primary xs:h-full xl:h-screen">
      <div className="container">
        <div className="py-[4.688rem]">
          <Link to="/">
            <div className="flex h-10 w-32 items-center justify-center rounded-md shadow-[0px_0_11px_-1px_rgba(0,0,0,0.3)]">
        ...
        {country.map((data) => (
          <div
            key={data.cca3}
            className="flex flex-col justify-between gap-11 pb-[4.688rem] lg:flex-row"
          >
